...
module.exports = function graphicParse(rawGraphic = {}, indexes = []) {
    ...
    return {
        labels: Object.values((_a = rawGraphic.dwglabels) !== null && _a !== void 0 ? _a : {}).map((l) => {
            var _a, _b;
            return ({
                id: l.id,
                x: indexes[l.x],
        ...
        lines: Object.values((_b = rawGraphic.dwglines) !== null && _b !== void 0 ? _b : {}).map((l) => {
            var _a, _b;
            return ({
                id: l.id,
                x1: indexes[l.x1],
        ...
        boxes: Object.values((_c = rawGraphic.dwgboxes) !== null && _c !== void 0 ? _c : {}).map((b) => {
            var _a, _b;
            return ({
                id: b.id,
                x1: indexes[b.x1],
        ...
        tables: Object.values((_d = rawGraphic.dwgtables) !== null && _d !== void 0 ? _d : {}).map((t) => ({
            id: t.id,
            position: t.pos,
            rows: t.rows,
            columns: t.cols,
            ...
            cells: () => {
                var _a;
                const matrix = [];
                Object.values((_a = rawGraphic.dwgtablecells) !== null && _a !== void 0 ? _a : {}).forEach((cell) => {
                    if (cell.tid !== t.id)
                        return;
                    if (!matrix[cell.row])
                        matrix[cell.row] = [];
        ...
        horizLines: Object.values((_e = rawGraphic.horizlines) !== null && _e !== void 0 ? _e : {}).map((h) => (Object.assign(Object.assign({}, h), { startIndex: indexes[h.startIndex], endIndex: indexes[h.endIndex] }))),
        polygons: Object.values((_f = rawGraphic.polygons) !== null && _f !== void 0 ? _f : {}).map((p) => (Object.assign(Object.assign({}, p), { points: p.points.map((pt) => (Object.assign(Object.assign({}, pt), { index: indexes[pt.index] }))) }))),
        horizHists: Object.values((_g = rawGraphic.hhists) !== null && _g !== void 0 ? _g : {}).map((h) => (Object.assign(Object.assign({}, h), { firstBarTime: indexes[h.firstBarTime], lastBarTime: indexes[h.lastBarTime] }))),
        raw: () => rawGraphic,
    };
};
